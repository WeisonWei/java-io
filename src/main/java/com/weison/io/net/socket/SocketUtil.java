...
public class SocketUtil {
    ...
    public static void bioSendMessage(String host, int port, String message) {
    ...
    public static void nioSendMessage(String host, int port, String message) throws IOException {
        // (1)创建发送和接受缓冲区
